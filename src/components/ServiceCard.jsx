    ...
    "Manajemen Terpadu Balita Sakit (MTBS)": <ActivitySquare className="text-orange-500 w-24 h-24 mb-2" />,
    "Layanan Gawat Darurat (UGD)": <AlertCircle className="text-orange-500 w-24 h-24 mb-2" />,
    "Pemeriksaan TB Paru": <Biohazard className="text-orange-500 w-24 h-24 mb-2" />,
